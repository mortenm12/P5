...
for split in splits:
    evaluationAlgorithms.append((EvaluationAlgorithm.prefabs["MRSMAE"], (0,  split)))
    evaluationNames.append(RatingEvaluator.format_name("MRSMAE", (0, split)))
    evaluationAlgorithms.append((EvaluationAlgorithm.prefabs["MRSMAE"], (split + 1,  1000)))
    evaluationNames.append(RatingEvaluator.format_name("MRSMAE", (split + 1,  1000)))
...
splits = [90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102]
...
print_splits(predictionAlgorithms, splits)